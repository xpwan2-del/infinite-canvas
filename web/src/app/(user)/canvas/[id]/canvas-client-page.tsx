...
function InfiniteCanvasPage() {
    ...
    return (
        <main className="flex h-full min-h-0 overflow-hidden" style={{ background: theme.canvas.background, color: theme.node.text }}>
            ...
            {localAgentMounted ? <CanvasLocalAgentPanel snapshot={agentSnapshot} canUndoOps={Boolean(agentUndoSnapshot)} collapsed={localAgentCollapsed} onApplyOps={applyAgentOps} onUndoOps={undoAgentOps} onCollapseStart={closeLocalAgent} /> : null}
        </main>
    );
}
